...
<template>
  <div class="navigation px-3 rounded-xl pt-8 mr-8 mb-8">
    <v-list class="bg-transparent">
        <v-list-item v-for="(item, i) in items" :key="i" class="rounded-lg text-white" :to="item.path">
            {{ item.name }}
        </v-list-item>
    </v-list>
    <div>
    ...
    <div color="transparent" v-if="false && appStore.mode === 'goodsPlanner'">
